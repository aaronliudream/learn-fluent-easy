...
- 🔴 **需跑** `american_am2_seed_unit07.sql` —— 本批新增 **L49–L54 + L56**(U7 起,教材 Unit 3),期望 **+308**(7 课×44)。⚠️ **L55 挂起**(内容过滤误判,Aaron+网页版处理中),U7 暂缺 L55、已跳到 L56+ 续做;L55 补齐后 seed 再 +44。
...
| 7 | `american_am2_seed_unit07.sql` | +308(7课×44,续增) | am2 U7 L49–L54 + L56:复合句连词/KS26状态动词/KS27一般过去/KS28现在完成vs完成进行/KS29+52三时态/KS30冠词综合/**KS32数量词与比较**,机器12项🟢;**⚠️缺 L55**(误判挂起,补齐再+44) | 无 |
