...
const GRADES: Array<{
...
}> = [
  {
    id: 3,
    name_cn: "三年级",
    image: "/images/primary/grade3-banner.jpg",
    imageAlt: "三年级插画：校园与字母积木",
    overlay: "from-amber-950/90 via-orange-900/45 to-black/25",
  },
  {
    id: 4,
    name_cn: "四年级",
    image: "/images/primary/grade4-banner.jpg",
    imageAlt: "四年级插画：草地与书本",
    overlay: "from-emerald-950/90 via-green-900/45 to-black/25",
  },
  {
    id: 5,
    name_cn: "五年级",
    image: "/images/primary/grade5-banner.jpg",
    imageAlt: "五年级插画：地球仪与城市",
    overlay: "from-sky-950/90 via-blue-900/45 to-black/25",
  },
  {
    id: 6,
    name_cn: "六年级",
    image: "/images/primary/grade6-banner.jpg",
    imageAlt: "六年级插画：毕业帽与夕阳",
    overlay: "from-orange-950/90 via-rose-900/45 to-black/25",
  },
];
