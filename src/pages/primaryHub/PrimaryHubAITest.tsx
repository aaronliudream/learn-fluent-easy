...
import { getTotalCompletedStages } from "@/lib/primaryHub/progress";
import { AI_DIMENSIONS, type DimResults, type QuizQuestion } from "@/lib/primaryHub/types";
import { DimensionBars } from "@/components/primaryHub/DimensionBars";
import { savePersist } from "@/lib/primaryHub/storage";

export default function PrimaryHubAITest() {
  const { grade, state, setState, addMistake } = usePrimaryHub();
