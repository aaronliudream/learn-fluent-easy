...
lines = open('scripts/senior-rebuild/elective4/_raw/full.txt', encoding='utf-8').read().split('\n')
...
for u in byunit:
    json.dump(byunit[u], open(f'scripts/senior-rebuild/elective4/_raw/wl_u{u}.json','w',encoding='utf-8'), ensure_ascii=False, indent=1)
