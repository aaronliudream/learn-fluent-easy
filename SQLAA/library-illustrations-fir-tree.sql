...
VALUES
  ...
  ((SELECT id FROM public.library_books WHERE book_key='fir-tree'), 5, 11, 'fir-tree/ch5-1-withered-star.jpg', '', '春天院子角落里,枯黄的枞树躺在杂草中,一个小孩扯下顶上的金星', 'AI illustration (watercolor)', 1000, 1000, true);
