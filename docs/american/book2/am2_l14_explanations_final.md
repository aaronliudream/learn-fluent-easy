...
### s5 seq6 | ans: after
"孩子们打碎玻璃之后跑了"——"在…之后"用 after,后接过去完成时 had broken。✓ ran away after they had broken the window.

### s5 seq7 | ans: As soon as
"太阳一下山我们就回旅馆"——"一…就…"用 As soon as,后接过去完成时 had set。✓ As soon as the sun had set, we returned.

### s5 seq8 | ans: after
"写完信之后去邮局"——先写完(had written)后去,用 after 引导。✓ She went to the post office after she had written the letter.

### s5 seq9 | ans: had not understood
过去完成时否定 = had not + 过去分词,常和 until 连用(直到…才…)。✓ I had not understood the problem until he explained it.

### s5 seq10 | ans: 相继发生按顺序讲用一般过去;回头看更早的用过去完成
两件相继发生、按先后顺序讲的事,用一般过去时;过去完成时是"回头看"更早发生的那件。✓

### s5 seq11 | ans: 一般过去(arrived, sat)
"到了然后坐下"是相继发生、按顺序讲的两件事,都用一般过去时 arrived, sat,不用过去完成时。✓

### s5 seq12 | ans: had … left
"我到车站之前,火车已经开走了"——开走在"到"之前,用过去完成时 had already left。✓ When I got to the station, the train had already left.

### s5 seq13 | ans: had planned
"本打算去购物,但妈妈来了(没去成)"——本打算而未实现,用 had planned to。✓ I had planned to go shopping, but my mom came.

### s5 seq14 | ans: had hoped
"原本希望他来,但他没来"——原本希望而落空,用 had hoped that。✓ She had hoped that he would come, but he didn't.
...
### s6 seq2 | ans: trip
美语里"旅程/旅行"更常说 trip;英式常说 journey。✓ a road trip.

### s6 seq3 | ans: vacation
美语"假期"用 vacation;英式用 holiday。✓ on vacation in France.
...
### s8 seq2 | ans: No, neither of them spoke
课文说 Neither of us spoke during the whole journey,一路上谁也没说话。

### s8 seq3 | ans: English
课文结尾说 the young man was English himself,那青年其实是英国人。

### s9 seq1 | ans: When I got to the station, the train had already left.
"火车开走"在"我到"之前,先发生的用过去完成时 had already left。✓ 场合:解释自己为什么没赶上车。

### s9 seq2 | ans: After she had finished her homework, she went to bed.
"写完作业"先发生,用 after + 过去完成时 had finished;"睡觉"后发生用一般过去 went。✓

### s9 seq3 | ans: I had planned to visit you, but I was too busy.
"本打算去看你但没成"用 had planned to,表示过去未实现的计划。✓ 场合:向朋友解释爽约。
...
### s10 seq4 | ans: had started
"我们到之前电影已经开始"——开始在"到"之前,用过去完成时 had started。✓ By the time we arrived, the movie had started.

### s10 seq5 | ans: 他吃饭(had eaten)
had eaten 是过去完成时,更早发生;washed 是一般过去时,后发生。所以先发生的是"吃饭"。✓

### s10 seq6 | ans: had planned to call
"本想打电话,可手机没电了(没打成)"用 had planned to call,表示过去未实现的打算。✓

### s10 seq7 | ans: He thought the young man was a local Frenchman
课文说作者以为那青年是本地法国人,所以用法语跟他说话。

### s10 seq8 | ans: The young man was actually English
课文结尾揭示那青年其实是英国人,这让作者很吃惊。

### s10 seq9 | ans: He waved at him on the way
课文说 On the way, a young man waved at me,青年在途中招手拦车。

### s10 seq10 | ans: Near the end, close to the town
课文说 I had nearly reached the town when the young man suddenly asked,快到镇上时他才问。
