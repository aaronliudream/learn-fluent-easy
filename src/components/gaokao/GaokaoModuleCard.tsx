...
export function GaokaoModuleCard({
  ...
  return (
    <Link
      to={to}
      className={cn(
        "group relative flex min-h-[224px] flex-col overflow-hidden rounded-2xl",
    ...
    >
      <div className="absolute inset-0">
        <img
          ...
          className="size-full object-cover transition-transform duration-700 group-hover:scale-110 brightness-110 saturate-125 contrast-105"
          loading="lazy"
        />
