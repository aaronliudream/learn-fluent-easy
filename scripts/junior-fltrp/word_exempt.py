...
★豁免表的管辖范围(Aaron 2026-07-26 定)★
本表管的是「这个词的**词义**学生已暴露、不用再解」,只约束**纯词义注释**。
若一条生词注释的功能是**构词法/语法对照**(-ed/-ing 对、派生对如 useful/useless),
则该词在豁免表**不构成排除理由** —— 学生认识 surprised,不等于分得清
`the wall is surprising`(修饰事物)与 `we were surprised`(修饰人),
而这个混淆是全学段最高频的语法错误之一。此类注释须写出功能说明
(如「令人惊奇的(修饰事物)」/「感到惊奇的(修饰人)」),而不是只给中文词义。
