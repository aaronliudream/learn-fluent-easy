-- Junior per-module stage tests (AI-generated at play time) + tighter list filter
...
-- Module-specific junior tests (grades 1–3 = 初一–初三 in stage_tests numbering)
DO $$
DECLARE
  g int;
...
-- On module hubs: show module tests + cross-module term/final only (not every NULL row)
