// 生成选择性必修一情景闯关题(context_questions, grade=10, volume='elective1'):从本地 vocab JSON 真实例句挖空。
...
for (const u of Object.keys(META)) {
  const m = META[u];
  const vf = JSON.parse(readFileSync(`scripts/senior-rebuild/elective1/${u}/${VOL}-${u}-vocab.json`, 'utf8'));
