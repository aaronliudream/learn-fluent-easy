# 2024 新版人教 八年级 英语 — 单元结构参考

> 来源:扫描版电子课本目录提取
> - 八上:`英语 人教版 八年级 上册 2024版.pdf`(150 页)
> - 八下:`1012664932-新八下英语-人教版.pdf`(154 页)
>
> ⚠️ app 现有 `src/data/juniorHub/grade8.json` 是**旧版 Go for it!**(每册 10 单元),需整册替换为下方新版(每册 **8** 单元)。
> 新版每单元固定结构:**BIG Question → Section A(听说 + Pronunciation 音标 + Grammar)→ Section B(Reading + Writing + Vocabulary + Project)**。
> 详细每单元词表/课文内容在重建各单元时再从对应正文页提取。

## 📘 八上(8A · 8 单元)

| U | 标题 | Big Question | 语法 | Pronunciation | 听力/口语 | 阅读 | 写作 | Project | 词汇板块 |
|---|---|---|---|---|---|---|---|---|---|
| 1 | Happy Holiday | What makes a great holiday? | 不定代词 + 一般过去时复习 | /iː/ /ɪ/ /i/ /e/ /æ/;rhythm | 假期经历对话 | Vincent 的暑假日记 | 写假期故事 | 假期 to-do list | Words related to holiday |
| 2 | Home Sweet Home | What does home mean to you? | Can/Could 礼貌请求与许可 | /ɔː/ /ɒ/ /uː/ /ʊ/ /ɑː/ /ʌ/;sense groups | 家务对话 | 回家过春节的故事 | 邮件求助布置房间 | 谁做家务最多 | Words related to home |
...
| U | 标题 | Big Question | 语法 | 听力/口语 | 阅读 | 写作 | Project | 词汇板块 |
|---|---|---|---|---|---|---|---|---|
| 1 | Time to Relax | Why are free-time activities important? | 不定式作状语/宾补 | 课余活动调查;培养爱好对话 | 两个少年的爱好(Hobbies That Are Good for You) | 写自己的爱好 | 课余活动调查 | 课余活动搭配 |
| 2 | Stay Healthy | How do we take care of ourselves? | 情态动词 should/could 建议;反身代词 | 健康问题对话;医患对话 | 一次烹饪事故 | 写医患对话 | 健康手册 | 健康问题词;-self/-selves/-less/-ache |
...
## 与 app 现状的差异(重建要点)
- 单元数:**旧 10+10 → 新 8+8(共 16)**。
- 旧版单元标题/话题/课文/听力全部作废,按上表替换。
- `junior_grammar_points` 的 `g8.*` code 需**重新挂到新单元**(部分语法点旧版已存在,可复用 code,但绑定单元变了)。
- 语法跨册重复(八上 U3/U4 比较级最高级、八下 U4 复习;现在完成时八下 U7/U8)——属正常教材编排。
- 情景闯关 761 题按词表(非单元)出题,**不受单元重建影响**。
