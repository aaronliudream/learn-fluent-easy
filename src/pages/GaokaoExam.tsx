    ...
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-8">
      ...
      <div className="mb-5 flex items-center gap-4 rounded-3xl bg-gradient-to-br from-amber-500 via-orange-500 to-rose-600 p-5 text-white shadow-tile">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[10px] font-bold uppercase tracking-[0.18em] opacity-90">GAOKAO · 综合冲刺</div>
          <h1 className="text-2xl font-extrabold leading-tight">高考英语综合区</h1>
          <p className="mt-0.5 text-xs opacity-90">真题模拟 + 三年综合诊断 + 错题攻坚 · 一站冲分</p>
        </div>
      </div>
