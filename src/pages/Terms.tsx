...
const Terms = () => {
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-10 md:px-8 md:py-14">
      <PageHeader title="服务条款 / Terms of Service" subtitle="最后更新：2026-04-29" back="/" />

      <article className="prose prose-sm max-w-none rounded-2xl bg-card p-6 shadow-card md:p-8 dark:prose-invert">
        <h2>中文版</h2>

        <h3>1. 接受条款</h3>
        <p>注册或使用 learn-fluent-easy（以下简称"本应用"）即表示你同意本服务条款。</p>

        <h3>2. 服务描述</h3>
        <p>本应用提供英语自适应学习功能，包括分级课程、水平测试、俚语学习、AI 批改等。</p>

        <h3>3. 用户责任</h3>
        <ul>
          <li>提供真实、准确的注册信息；</li>
          <li>保管好账户密码，不与他人共享；</li>
          <li>不得用本应用从事任何违法或侵权活动；</li>
          <li>不得对应用进行反向工程、抓取或滥用 API。</li>
        </ul>

        <h3>4. 知识产权</h3>
        <p>本应用的代码、设计、课程内容均归 learn-fluent-easy 团队所有。AI 生成的内容仅供学习使用。</p>

        <h3>5. 免责声明</h3>
        <p>
          本应用按"现状"提供，不对内容的完全准确性作出保证。AI 生成的批改与建议仅供参考，
          不能替代专业语言教师的指导。
        </p>

        <h3>6. 服务变更与终止</h3>
        <p>我们可能随时更新或终止部分功能，并会提前通知重大变更。你可随时删除账户终止本协议。</p>

        <h3>7. 适用法律</h3>
        <p>本条款的解释与执行适用相关司法管辖区的法律。</p>
