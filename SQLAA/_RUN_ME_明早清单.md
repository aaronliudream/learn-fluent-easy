...
| # | 文件 | 期望 COUNT | 说明 | 依赖 |
|---|---|---|---|---|
| 1 | `american_am2_seed_unit02.sql` | 355(不变) | 幂等重跑:补 L10/L11…(直到 L16)的 ④⑤⑥(stem_cn/词义题补英文/关7错因),仅 payload 更新,题数不变 | 无 |
| 2 | `american_am2_seed_unit01.sql` | 356(不变) | 幂等重跑:补 L1–L8 的 ④⑤⑥(待 CC 产) | 无 |
