      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-60">
          ...
          <DropdownMenuItem asChild>
            <Link to="/me"><UserIcon className="mr-2 size-4" />我的账户</Link>
          </DropdownMenuItem>
          <DropdownMenuItem asChild>
            <Link to="/dashboard"><BarChart3 className="mr-2 size-4" />学习进度</Link>
          </DropdownMenuItem>
          <DropdownMenuItem asChild>
            <Link to="/mistakes"><BookMarked className="mr-2 size-4" />错题本</Link>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem
            onClick={async () => {
