...
- 🔴 **需跑** `american_am2_seed_unit07.sql` —— 本批新增 **L49**(U7 起,教材 Unit 3 首课),期望 **+44**(1 课×44)。
...
| 7 | `american_am2_seed_unit07.sql` | +44(1课×44,续增) | am2 U7 L49(教材 Unit 3 首课 The end of a dream 复合句连词 because/when/although/not…until/after),机器12项🟢零黄警;L50-56 陆续追加 | 无 |
