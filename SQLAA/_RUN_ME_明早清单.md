...
- 🔴 **需跑** `american_am2_seed_unit07.sql` —— 本批新增 **L49、L50、L51、L52**(U7 起,教材 Unit 3),期望 **+176**(4 课×44)。
...
| 7 | `american_am2_seed_unit07.sql` | +176(4课×44,续增) | am2 U7 L49(复合句连词)+ L50(KS26 一般现在/状态动词 + SD26)+ L51(KS27 一般过去时 + SD27)+ L52(KS28 现在完成 vs 完成进行 + SD28 形/副辨析),机器12项🟢;L53-56 陆续追加 | 无 |
