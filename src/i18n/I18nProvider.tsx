...
const EN_FALLBACKS: Record<string, string> = {
  ...
  "学习赚星币，喂养专属伙伴": "Learn to earn Star Coins, feed your exclusive companions",
  "种子": "Seeds",
  "消化中": "Digesting",
  "登录后开启宠物之旅": "Log in to start your pet journey",
  "学习赚星币 → 领养 → 喂养 → 进化 → 出游": "Learn → Earn coins → Adopt → Feed → Evolve → Travel",
  "立即登录": "Log in now",
  "🏠 我家": "🏠 Home",
  "🛒 商店": "🛒 Shop",
  "🗺️ 出游": "🗺️ Go out",
  ...
  "心情": "Mood",
  "还没有宠物哦": "No pets yet",
  "去「领养」标签页带一只回家吧！": "Go to the \"Adopt\" tab to bring one home!",
  "表情贴纸": "Stickers",
  "已解锁": "Unlocked",
  "解锁": "unlock",
  "喂它吃点东西": "Feed it something",
  "点食物即可喂食": "Tap on food to feed",
  "背包空空，去「商店」买点食物吧 🛒": "Your backpack is empty. Go to the \"Shop\" to buy some food 🛒",
  "我的伙伴们": "My companions",
  "学习朋友圈": "Study Moments",
  "互访朋友的伙伴 · 送礼物 · 拍合影": "Visit a friend's partner · Send gifts · Take a group photo",
  "小伙伴": "Buddy",
  // Currency tooltips
  "种子：学习产出，可在商店心愿单兑换": "Seeds: earned from learning, redeemable in the shop wishlist",
  "刚学到的种子正在宠物体内消化，明天到账": "Newly earned seeds are digesting inside your pet — they'll arrive tomorrow",
  "星光：连续学习奖励，未来可解锁场景": "Starlight: streak reward, will unlock scenes in the future",
  "结晶：完成长期里程碑获得，购买稀有道具": "Crystals: earned by reaching long-term milestones, buy rare items",
  // Evolution tree
  "成长之路": "Path of Growth",
