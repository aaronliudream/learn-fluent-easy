...
export const PRIMARY_ROLE_PLAYS: RolePlay[] = [
...

  {
    ...
    emoji: "🏫",
    title_cn: "到校问候",
    title_en: "Greeting at School",
    scene_cn: "早上到校门口,同学向你挥手",
    bg: "from-orange-400 to-rose-500",
    category: "school",
    difficulty: 1,
    sortOrder: 1,
    lines: [
      { speaker: "同学", emoji: "👧", side: "right", text_en: "Hello! Good morning!", text_cn: "你好!早上好!" },
      { speaker: "你", emoji: "👦", side: "left", text_en: "Hi! Good morning!", text_cn: "嗨!早上好!" },
      { speaker: "同学", emoji: "👧", side: "right", text_en: "How are you?", text_cn: "你好吗?" },
    ],
    choices: [
      { text_en: "I'm fine, thank you.", text_cn: "我很好,谢谢。", correct: true, feedback_cn: "🌟 完美!How are you 要答 I'm fine, thank you" },
      { text_en: "My name is Amy.", text_cn: "我叫 Amy。", correct: false, feedback_cn: "那是回答 What's your name 的哦~" },
      { text_en: "Goodbye!", text_cn: "再见!", correct: false, feedback_cn: "刚见面不说再见,要先问好哦~" },
    ],
  },
  {
    id: "rp2",
    emoji: "👋",
    title_cn: "认识新同学",
    title_en: "Meet a New Classmate",
    scene_cn: "教室里,新同学坐在你旁边",
    bg: "from-pink-400 to-fuchsia-500",
    category: "school",
    difficulty: 1,
    sortOrder: 2,
    lines: [
      { speaker: "新同学", emoji: "👧", side: "right", text_en: "Hi! What's your name?", text_cn: "嗨!你叫什么?" },
      { speaker: "你", emoji: "👦", side: "left", text_en: "My name is Amy.", text_cn: "我叫 Amy。" },
      { speaker: "新同学", emoji: "👧", side: "right", text_en: "Nice to meet you!", text_cn: "很高兴认识你!" },
    ],
    choices: [
      { text_en: "Nice to meet you too!", text_cn: "我也很高兴认识你!", correct: true, feedback_cn: "🌟 完美!认识新朋友要说 Nice to meet you too" },
      { text_en: "I am fine.", text_cn: "我很好。", correct: false, feedback_cn: "那是回答 How are you 的哦~" },
      { text_en: "Yes.", text_cn: "是的。", correct: false, feedback_cn: "要把完整的礼貌话说出来哦~" },
    ],
  },
  {
    id: "rp3",
    ...
    scene_cn: "上课了,老师微笑着问你",
    bg: "from-emerald-400 to-teal-500",
    category: "school",
    difficulty: 1,
    sortOrder: 3,
    lines: [
      { speaker: "老师", emoji: "👩‍🏫", side: "right", text_en: "Good morning, class!", text_cn: "早上好,同学们!" },
      { speaker: "你", emoji: "👦", side: "left", text_en: "Good morning, teacher!", text_cn: "早上好,老师!" },
      { speaker: "老师", emoji: "👩‍🏫", side: "right", text_en: "How are you today?", text_cn: "你今天好吗?" },
    ],
    choices: [
      { text_en: "I'm fine, thank you.", text_cn: "我很好,谢谢。", correct: true, feedback_cn: "🌟 完美!课堂上也要礼貌回答 How are you" },
      { text_en: "Yes, I am.", text_cn: "是的,我是。", correct: false, feedback_cn: "How are you 不能用 Yes 回答~" },
      { text_en: "Goodbye!", text_cn: "再见!", correct: false, feedback_cn: "上课刚开始,不说再见哦~" },
    ],
  },
  {
    id: "rp4",
    ...
    scene_cn: "放学了,你和同学在校门口",
    bg: "from-amber-400 to-orange-500",
    category: "school",
    difficulty: 1,
    sortOrder: 4,
    lines: [
      { speaker: "同学", emoji: "👧", side: "right", text_en: "School is over!", text_cn: "放学啦!" },
      { speaker: "你", emoji: "👦", side: "left", text_en: "Yes! Bye!", text_cn: "对!拜拜!" },
      { speaker: "同学", emoji: "👧", side: "right", text_en: "See you tomorrow!", text_cn: "明天见!" },
    ],
    choices: [
      { text_en: "See you! Goodbye!", text_cn: "明天见!再见!", correct: true, feedback_cn: "🌟 完美!放学要说 See you 或 Goodbye" },
      { text_en: "Good morning!", text_cn: "早上好!", correct: false, feedback_cn: "放学了,不说早上好哦~" },
      { text_en: "What's your name?", text_cn: "你叫什么?", correct: false, feedback_cn: "道别时不用问名字啦~" },
    ],
  },
  {
    id: "rp5",
