# 选择性必修三 单元内容生产契约(每个单元 9 个 JSON 文件)

你为**一个单元**生产全部内容文件,落在 `scripts/senior-rebuild/elective3/<u>/`,命名严格为
...
```
node scripts/senior-rebuild/elective3/_balance.mjs --unit <u>
node scripts/qc-unit.mjs --dir scripts/senior-rebuild/elective3/<u> --vol elective3 --unit <U大写>
```
