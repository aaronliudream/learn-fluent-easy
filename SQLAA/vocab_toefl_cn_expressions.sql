...
SELECT e.id, v.rendition, v.register, v.scene_hint, v.example_en, v.example_zh, v.sort_order
  FROM (VALUES
    ...
    ('人无远虑,必有近忧', 'Failing to plan is planning to fail.', 'formal', '强调计划的重要性', 'She learned that failing to plan is planning to fail.', '她终于明白,人无远虑,必有近忧。', 1),
    ('人无远虑,必有近忧', 'Trouble comes to those who don''t plan ahead', 'neutral', '劝人早做打算', 'Trouble comes to those who don''t plan ahead. Always think about the future.', '人无远虑,必有近忧。常思未来。', 2),
