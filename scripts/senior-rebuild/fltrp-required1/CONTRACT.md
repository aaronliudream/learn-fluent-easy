...
你为**一个单元**生产全部内容文件,落在 `scripts/senior-rebuild/sufe-required1/<u>/`,命名严格为
`required1-<u>-<name>.json`(小写,如 `required1-u1-vocab.json`)。
...
### required1-<u>-vocab.json  —— 词汇 44~52 个
```
{ "volume":"required1","unit":"U1","book_cn":"必修第二册","unit_cn":"...","source":"...",
...
### required1-<u>-grammar.json —— 3 点 × 20 题 = **60 题**
```
{ "volume":"required1","unit":"U1","grammar_title":"...","source":"...",
...
### required1-<u>-reading.json —— **6 篇**,每篇 3 题(共18),body **120~210 词**
```
{ "volume":"required1","unit":"U1","topic":"Cultural Heritage","source":"...",
...
### required1-<u>-cloze.json —— **6 篇**,每篇 10 空(共60)
```
{ "volume":"required1","unit":"U1","topic":"...","source":"...",
...
### required1-<u>-listening.json —— **6 篇**,每篇 5 题(共30),long/short 交替(3长3短)
```
{ "volume":"required1","unit":"U1","topic":"...","tts_voice":"nova","source":"...",
...
### required1-<u>-writing.json —— 1 篇(照 U5 字段全给)
...
### required1-<u>-finalreading.json —— 单元通关迷你阅读
```
{ "volume":"required1","unit":"U1","note":"...",
...
### required1-<u>-grammar-tips.json —— 语法小知识卡
```
{ "volume":"required1","unit":"U1","grade":10,
...
```
node scripts/senior-rebuild/sufe-required1/_balance.mjs --unit <u>
node scripts/qc-unit.mjs --dir scripts/senior-rebuild/sufe-required1/<u> --vol required1 --unit <U大写> --outlabel sufe-required1-<U大写>
```
