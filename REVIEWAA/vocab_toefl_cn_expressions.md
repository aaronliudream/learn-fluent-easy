...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **I'm just saying.** | 用于朋友间随意聊天 | I'm just saying, maybe we should try a new restaurant.<br>我随便说说,或许我们该试试新的餐馆。 |
| neutral | **It's just a thought.** | 用于表达不确定想法 | It's just a thought, but maybe we could start earlier.<br>我随便说说,但或许我们可以早点开始。 |
| formal | **This is merely a suggestion.** | 用于正式场合表达建议 | This is merely a suggestion for your consideration.<br>我随便说说,供你参考。 |

**没问题**(表示同意或接受)

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **No problem.** | 用于朋友间回应请求 | No problem, I'll help you move on Saturday.<br>没问题,我周六帮你搬家。 |
| neutral | **That sounds fine.** | 用于一般场合表示同意 | That sounds fine, let's meet at 3 PM.<br>没问题,我们下午3点见。 |
| formal | **I have no objections.** | 用于正式场合表示同意 | I have no objections to the proposed plan.<br>我对提议的计划没问题。 |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **Don't get mad.** | 用于朋友间安抚情绪 | Don't get mad, it was just a joke.<br>别生气,这只是个玩笑。 |
| neutral | **Try to stay calm.** | 用于一般场合安抚情绪 | Try to stay calm while we sort this out.<br>我们处理这件事时,你尽量别生气。 |
| formal | **Please remain composed.** | 用于正式场合安抚情绪 | Please remain composed during the discussion.<br>在讨论期间请别生气。 |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| neutral | **I don't understand** | 一般场合表达不解 | I don't understand what you mean by that.<br>我不明白你那是什么意思。 |
| casual | **I'm lost** | 随意场合表达不解 | I'm lost. Can you explain it again?<br>我不明白。你能再解释一下吗? |
| formal | **I'm not clear on that** | 正式场合表达不解 | I'm not clear on that point. Could you elaborate?<br>我不明白那一点。你能详细说明吗? |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| neutral | **I'm happy** | 一般场合表达开心 | I'm happy to hear about your success.<br>我很高兴听到你的成功。 |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| neutral | **I didn't hear you** | 一般场合表示没听清 | I'm sorry, I didn't hear you. Could you repeat that?<br>抱歉,我没听见。你能再说一次吗? |
| casual | **I missed that** | 朋友间表示没听清 | I missed that, can you say it again?<br>我没听见,你能再说一次吗? |
| formal | **I did not catch that** | 正式场合表示没听清 | I did not catch that last point, could you clarify?<br>我没听见最后一点,你能澄清吗? |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| neutral | **Be careful** | 一般场合提醒注意安全 | Be careful when you drive in the rain.<br>下雨开车时小心点。 |
| casual | **Watch out** | 随意场合提醒注意安全 | Watch out for the wet floor!<br>小心点,地滑! |
| formal | **Exercise caution** | 正式场合提醒注意安全 | Please exercise caution when handling chemicals.<br>处理化学品时请小心点。 |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **I'm starving.** | 朋友间随意表达 | Let's grab a burger, I'm starving.<br>我们去吃个汉堡吧,我饿了。 |
| neutral | **I'm hungry.** | 一般场合表达饥饿 | Do you have any snacks? I'm hungry.<br>你有零食吗? 我饿了。 |

**你有空吗**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **Got a sec?** | 朋友间随意询问 | Hey, got a sec to chat?<br>嘿,你有空聊聊吗? |
| neutral | **Are you available?** | 一般场合询问时间 | Are you available for a meeting tomorrow?<br>你明天有空开会吗? |

**我保证**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **I swear.** | 承诺时的随意说法 | I swear, I left the keys right here.<br>我保证,我把钥匙放在这里了。 |
| neutral | **I assure you.** | 一般场合保证某事 | I assure you, the product will be delivered on time.<br>我保证,产品会按时交付。 |

**关灯**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **Kill the lights.** | 非正式场合关灯 | It's movie time, kill the lights.<br>电影时间到了,关灯吧。 |
| neutral | **Turn off the lights.** | 一般场合要求关灯 | Please turn off the lights when you leave.<br>请离开时关灯。 |

**去散步**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **Go for a stroll.** | 朋友间随意提议 | It's a nice evening, let's go for a stroll.<br>今天天气不错,我们去散步吧。 |
| neutral | **Take a walk.** | 一般场合建议散步 | I like to take a walk after dinner.<br>我喜欢晚饭后去散步。 |

**我不在乎**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **I don't care.** | 随意表达无所谓 | I don't care what they think.<br>我不在乎他们怎么想。 |
| neutral | **It doesn't matter to me.** | 一般场合表示不在乎 | It doesn't matter to me if we go or not.<br>我不在乎我们去不去。 |

**我很无聊**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **I'm bored to death.** | 非正式表达极端无聊 | This lecture is endless, I'm bored to death.<br>这堂课没完没了,我很无聊。 |
| neutral | **I'm bored.** | 一般场合表达无聊 | I'm bored, let's do something fun.<br>我很无聊,我们做点有趣的事吧。 |

**真可惜**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **What a bummer.** | 朋友间表示遗憾 | The concert's canceled, what a bummer.<br>演唱会取消了,真可惜。 |
| neutral | **That's unfortunate.** | 一般场合表示遗憾 | That's unfortunate, I was looking forward to it.<br>真可惜,我很期待的。 |

**我想休息一下**

| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **I need a break.** | 随意表达需要休息 | I've been studying all day, I need a break.<br>我学习了一整天,我想休息一下。 |
| neutral | **I want to take a rest.** | 一般场合表示休息 | After the meeting, I want to take a rest.<br>会议结束后,我想休息一下。 |
...
| 语域 | 英文说法 | 什么场合用 | 例句 |
| --- | --- | --- | --- |
| casual | **You're right** | 随意同意他人观点 | You're right, this movie is really good.<br>你说得对,这电影确实不错。 |
| neutral | **That is correct** | 一般场合确认他人正确 | That is correct, the meeting starts at 3 PM.<br>你说得对,会议三点开始。 |
| formal | **You are absolutely correct** | 正式场合强调对方正确 | You are absolutely correct in your assessment.<br>你说得对,你的评估很准确。 |
