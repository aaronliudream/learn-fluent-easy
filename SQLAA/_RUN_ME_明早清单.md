...
| 9 | `american_am2_seed_unit09.sql`(**新建·续增**) | +308(7课×44,续增) | am2 U9 L65(KS17 must/have to/should/ought to + should/ought to have done过去本应做 + SD let短语动词·agree/accept·dress up/dress)+ L66(KS18+42使役结构 have sth done + SD集合名词美语单数·净化包)+ L67(KS43 can/be able to/manage to + SD say/tell短语)+ L68(KS20+44动名词-ing作宾语 + 逻辑主语/感官动词/go-come/反义疑问·净化包)+ L69(**方案B换情节**《老爷车重获新生》被动语态综合复习——一般过去/情态/现在完成/过去完成/过去进行/完成非谓语被动)+ **L71**(《A famous clock 一个著名的大钟》Review KS60-69综合复习——与过去相反虚拟条件句/各时态被动/have sth done/现在完成·过去完成进行·将来完成 + SD official·employee·salesclerk·hang→hung悬挂·🟡试读通过)+ **L72**(《A car called Bluebird “蓝鸟”汽车》Review SD50-71易混词复习——lose/miss·expect/wait·raise/rise·value/cost/price·accept/agree·say/tell·hung悬挂·hard/hardly·near/nearly + 课文过去完成被动had been built/a mistake had been made·✅正常读),机器12项🟢;**L70(🔴换情节包待网页版,单元内空缺待补)** 陆续追加 | 无 |

| 10 | `american_am2_seed_unit10.sql`(**新建·续增**) | +88(2课×44,续增) | am2 U10(=教材 Unit 4,L73-80)L73(《The record-holder 纪录保持者》KS1/25/49 简单句·并列句·复合句——who/whose·when/as·after+分词·although/in spite of/though·not only...but...as well·such...that·before + 课文被动复习was given/was picked up/wasn't noticed by anyone + 词汇辨析evade/ashamed/imagination·🟢低正常读)+ L74(《Too Good to Be True 好得不像真的》**方案B换情节包**——KS2/26/50 现在进行vs一般现在 + 状态动词不用进行 + SD get短语get out/into/over/on with/off/through·名演员拍电影化装太逼真被误当粉丝赶出的喜剧),机器12项🟢;L75-80 陆续追加。**注**:教材 Unit 4 起换格式(24短文·课后无理解题·KS 改为复习前三单元语法),语言点仍在,流水线兼容 | 无 |
