...
7. **中文题干须自然，场景须与课本一致**（finalQuiz / readWrite / 句型关中文同理）：
   - 中文须符合母语者习惯，**禁止**按英文句式逐字硬译（如把 how are 译成「……今天怎么样？」指价格/贵贱）。
   - **「场景一致」≠ 全 Unit 统一一种货币**。须先翻课本对应章节（A / B、Let's learn / Let's talk），按**该页原文**写价：
     - **四下 U6 示例**：A 部分（Let's learn / A talk / 促销海报等）→ **yuan / ¥ / 元**；B 部分（专卖店 Sarah 与妈妈问 skirt 价 **$89** 等）→ **dollar / $ / 美元**。
     - 其他 Unit：人物在中国≠强行全改成元；课本若混用 $ 与 ¥，题目按**当题课文段落**还原，勿简化成「一律 yuan」。
   - 涉及货币、角色、地点的判断：**必须先对照课本 PDF/逐页原文**，再写题干；勿凭「学生在中国」推断全书货币。
   - 自检：读题干出声，是否像小学语文老师会写的提示？价标是否与当题所属 A/B 部分一致？
