# 上外elective4 单元内容生产契约(每个单元 9 个 JSON 文件)

你为**一个单元**生产全部内容文件,落在 `scripts/senior-rebuild/sufe-elective4/<u>/`,命名严格为
`elective4-<u>-<name>.json`(小写,如 `elective4-u1-vocab.json`)。

参考样板(elective4 U5,质量已真机验收,**字段名/结构 1:1 照抄,只换内容**):
...
### elective4-<u>-vocab.json  —— 词汇 44~52 个
```
{ "volume":"elective4","unit":"U1","book_cn":"必修第二册","unit_cn":"...","source":"...",
...
### elective4-<u>-grammar.json —— 3 点 × 20 题 = **60 题**
```
{ "volume":"elective4","unit":"U1","grammar_title":"...","source":"...",
...
### elective4-<u>-reading.json —— **6 篇**,每篇 3 题(共18),body **120~210 词**
```
{ "volume":"elective4","unit":"U1","topic":"Cultural Heritage","source":"...",
...
### elective4-<u>-cloze.json —— **6 篇**,每篇 10 空(共60)
```
{ "volume":"elective4","unit":"U1","topic":"...","source":"...",
...
### elective4-<u>-listening.json —— **6 篇**,每篇 5 题(共30),long/short 交替(3长3短)
```
{ "volume":"elective4","unit":"U1","topic":"...","tts_voice":"nova","source":"...",
...
### elective4-<u>-writing.json —— 1 篇(照 U5 字段全给)
...
### elective4-<u>-finalreading.json —— 单元通关迷你阅读
```
{ "volume":"elective4","unit":"U1","note":"...",
...
### elective4-<u>-grammar-tips.json —— 语法小知识卡
```
{ "volume":"elective4","unit":"U1","grade":10,
...
```
node scripts/senior-rebuild/sufe-elective4/_balance.mjs --unit <u>
node scripts/qc-unit.mjs --dir scripts/senior-rebuild/sufe-elective4/<u> --vol elective4 --unit <U大写> --outlabel sufe-elective4-<U大写>
```
