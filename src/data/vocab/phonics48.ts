...
export const PHONICS_48: PhonicsCard[] = [
  ...
  { id: "oi", ipa: "/ɔɪ/", kind: "vowel", group: "双元音", tip: "从圆唇 /ɔ/ 滑向 /ɪ/,唇形由圆变扁。", cnError: "唇形不变,读成单个音。", words: ["boy", "coin", "join"], focus: ["oy", "oi", "oi"], advanced: ["exploit", "adjoin"] },
  { id: "au", ipa: "/aʊ/", kind: "vowel", group: "双元音", tip: "从 /a/ 滑向 /ʊ/,嘴由大张收成圆。", cnError: "收圆不到位,how 听着像 ha。", words: ["how", "now", "out"], focus: ["ow", "ow", "ou"], advanced: ["profound", "devour"] },
  ...
  { id: "ie", ipa: "/ɪə/", kind: "vowel", group: "双元音", tip: "从 /ɪ/ 滑向 /ə/,后半段极轻。", cnError: "把 /ə/ 读成饱满的「儿」。", words: ["here", "ear", "near"], focus: ["ere", "ear", "ear"], advanced: ["sincere", "adhere"] },
  ...
  { id: "ue", ipa: "/ʊə/", kind: "vowel", group: "双元音", tip: "从 /ʊ/ 滑向 /ə/,唇由圆转松。现代英音里常并入 /ɔː/。", cnError: "读成 /uː/ + 儿化。", words: ["poor", "sure", "tour"], focus: ["oor", "ure", "our"], advanced: ["allure", "endure"] },
  ...
  { id: "h", ipa: "/h/", kind: "consonant", group: "摩擦音(清)", tip: "口腔放松,气流从声门直接呼出,像哈气。", cnError: "用汉语「喝」的摩擦,过重。", words: ["hat", "he", "home"], focus: ["h", "h", "h"], advanced: ["inherent", "cohesive"] },
  ...
  { id: "tr", ipa: "/tr/", kind: "consonant", group: "塞擦音(清)", tip: "/t/ 后紧跟 /r/,双唇略突,一个动作完成。", cnError: "拆成两个音「特-若」。", words: ["tree", "train", "try"], focus: ["tr", "tr", "tr"], advanced: ["intrinsic", "traverse"] },
  { id: "dr", ipa: "/dr/", kind: "consonant", group: "塞擦音(浊)", tip: "/d/ 后紧跟 /r/,声带振动。", cnError: "拆成两个音「的-若」。", words: ["dream", "drink", "draw"], focus: ["dr", "dr", "dr"], advanced: ["hindrance", "withdraw"] },
  ...
  /* ── 辅音 · 鼻音 3 ── */
  { id: "m", ipa: "/m/", kind: "consonant", group: "鼻音", tip: "双唇闭合,气流从鼻腔出,声带振动。", cnError: "词尾不闭唇,time 听着像 tie。", words: ["man", "time", "come"], focus: ["m", "m", "m"], advanced: ["momentum", "diminish"] },
  ...
  { id: "y", ipa: "/j/", kind: "consonant", group: "半元音", tip: "舌前部抬向硬腭,快速滑向后面的元音。", cnError: "读成汉语「衣」并拖长。", words: ["yes", "you", "year"], focus: ["y", "y", "y"], advanced: ["yield", "beyond"] },
