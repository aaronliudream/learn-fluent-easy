...
export const EN: Record<StringKey, string> = {
  ...
  "index.section.placement.cta": "Start test",
...
export const ZH: Record<StringKey, string> = {
  ...
  "index.section.placement.cta": "开始测试",
  ...
  "index.section.workplace.desc": "真实对话 · {count} 个场景 · 高频实战表达",
  ...
  "index.workplace.subtitle": "真实对话 · 高频表达 · 每月更新",
