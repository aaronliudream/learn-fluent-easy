-- ============================================================
-- ★已执行(2026-07-26)★ Aaron 在 Supabase Dashboard 手动跑了**等效的裸语句**
--   (ALTER ADD COLUMN + COMMENT 两句),未带本文件的断言与校验 SELECT。
--   事后核对:列已存在、junior_vocab 总行 8587、syllabus_level 非 NULL 行 0 —— 与本文件预期一致。
--   本文件保留为该变更的可追溯记录,**不需要再跑**(ADD COLUMN IF NOT EXISTS 重跑也无害)。
-- ============================================================
