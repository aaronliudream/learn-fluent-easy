  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      <p className="text-muted-foreground mb-6">
        输入你的英语问题，AI 会生成讲解 + 例句 + 3 题小测验，一键生成可分享的卡片。
      </p>
      ...
      <Card className="p-4 space-y-4">
        ...
        <Button onClick={submit} disabled={loading} size="lg" className="w-full">
          {loading ? (<><Loader2 className="w-4 h-4 mr-2 animate-spin" />生成中…（约 10 秒）</>) : "生成知识卡 →"}
        </Button>
      </Card>

      <div className="mt-6">
        <p className="text-sm text-muted-foreground mb-2">不知道问什么？试试：</p>
