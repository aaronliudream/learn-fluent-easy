#!/usr/bin/env python3
"""Replace g4v2_u2 block in grade4.json from scripts/g4v2_u2_unit.json."""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
GRADE = ROOT / "src/data/primaryHub/grade4.json"
UNIT = ROOT / "scripts/g4v2_u2_unit.json"
...
def main() -> None:
    ...
    for i, u in enumerate(units):
        ...
        raise SystemExit("g4v2_u2 not found")
    GRADE.write_text(json.dumps(data, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print("patched g4v2_u2 in grade4.json")
