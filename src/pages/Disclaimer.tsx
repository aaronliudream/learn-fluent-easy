  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-10 md:px-8 md:py-14">
      ...
      <article className="prose prose-sm max-w-none rounded-2xl bg-card p-6 shadow-card md:p-8 dark:prose-invert">
        ...
        <h3><T>2. 学习效果声明</T></h3>
        <p>
          <T>本应用 <strong>不承诺、不保证</strong> 任何具体的考试分数、提分幅度、录取结果或学习效果。学习成果取决于使用者自身的投入时间、基础水平、学习方法等多种因素。</T>
        </p>
        <p>
          <T>本应用的核心价值在于：通过 AI 技术帮助你 <strong>识别薄弱知识点</strong>、提供 <strong>科学的复习路径</strong>、记录 <strong>长期学习数据</strong>，作为你学习过程中的辅助工具。</T>
        </p>

        <h3><T>3. AI 生成内容声明</T></h3>
        <p>
          <T>本应用使用人工智能（包括但不限于 Google Gemini、OpenAI GPT 系列）生成课程内容、批改、释义与建议。AI 输出可能存在 <strong>事实性错误、语法不严谨或文化偏差</strong>，仅供学习参考，不可作为权威答案。如发现错误，欢迎通过反馈按钮告知我们。</T>
        </p>
