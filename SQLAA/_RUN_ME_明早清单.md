...
- 🔴 **需跑** `american_am2_seed_unit07.sql` —— 本批新增 **L49–L53**(U7 起,教材 Unit 3),期望 **+220**(5 课×44)。
...
| 7 | `american_am2_seed_unit07.sql` | +220(5课×44,续增) | am2 U7 L49(复合句连词)+ L50(KS26 一般现在/状态动词)+ L51(KS27 一般过去时)+ L52(KS28 现在完成 vs 完成进行)+ L53(KS29+52 三时态综合复习 + 易混词),机器12项🟢;L54-56 陆续追加 | 无 |
